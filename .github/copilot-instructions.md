...
Todas as mensagens de commit devem seguir o padrão **Conventional Commits** para garantir clareza e rastreabilidade das alterações. Exemplos de mensagens:

- `feat: adicionar página de detalhes da tarefa`
- `fix: corrigir erro de carregamento dos anexos`
